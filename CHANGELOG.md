...
* feat: crossplane-github-provider Crossplane provider stack (by @patrickleet)

  GitHub provider, ProviderConfig, and ExternalSecret-sourced credentials.
...
* refactor: rename to GitHubProviderStack on crossplane.ops.com.ai group (by @patrickleet)

  Renamed XRD kind to GitHubProviderStack, API group to crossplane.ops.com.ai, and the
  repo/package to crossplane-github-provider-stack. No consumers yet; pre-release.
